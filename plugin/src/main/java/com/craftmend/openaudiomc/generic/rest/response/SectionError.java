...
public enum SectionError {
    ...
    VOICECHAT_DISABLED("You can't use voicechat on this server"),
    VOICECHAT_ALREADY_CONNECTED("You are already connected to voicechat"),
    VOICECHAT_NOT_CONNECTED("You are not connected to voicechat"),

    ALREADY_CLAIMED("This server is already linked to an account! Please unlink it before trying to connect it again"),
    ;
