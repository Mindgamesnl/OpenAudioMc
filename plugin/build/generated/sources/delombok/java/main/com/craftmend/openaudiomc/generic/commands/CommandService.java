...
public class CommandService extends Service {
    ...
    private final CommandMiddleware[] defaultCommandMiddleware = new CommandMiddleware[] {new CatchLegalBindingMiddleware(), new CatchCrashMiddleware(), new CleanStateCheckMiddleware()};
    ...
    public CommandService() {
        ...
        registerSubCommands(CommandContext.OPENAUDIOMC, new HelpSubCommand(CommandContext.OPENAUDIOMC, true), new LinkSubCommand(), new ReloadSubCommand(), new StateSubCommand(), new ModulesSubCommand(), new ClientsSubCommand(), new StopSubCommand(), new PlaySubCommand(), new PreloadSubCommand(), new SetKvSubCommand());
