...
public class VelocityUserHooks implements UserHooks {
    ...
    public void sendPacket(User user, StandardPacket packet) {
        OpenAudioMcVelocity.getInstance().getMessageReceiver().sendPacket(new PacketPlayer((Player) user.getOriginal()), packet);
    }
    ...
    public VelocityUserHooks(final OpenAudioMcVelocity velocity) {
