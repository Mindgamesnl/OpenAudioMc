...
public final class OpenAudioMcSpigot extends JavaPlugin implements OpenAudioInvoker {
    ...
    public void onEnable() {
        ...
        try {
            ...
            openAudioMc.getServiceManager().loadServices(SpigotDependencyService.class, AliasService.class, ExecutorService.class, ServerService.class, SpigotPlayerService.class, SpeakerService.class, SpigotCommandService.class, ShowService.class, PredictiveMediaService.class, SpigotVoiceChatService.class, VoiceChannelService.class, FilterService.class, MediaRuleService.class, PlaylistService.class);
            OpenAudioMc.getService(SpigotDependencyService.class).ifPluginEnabled("LiteBans", new LitebansIntegration()).ifPluginEnabled("Essentials", new EssentialsIntegration()).ifPluginEnabled("WorldGuard", new RegionService(this)).ifPluginEnabled("Train_Carts", new TrainCartsService(this)).ifPluginEnabled("PlaceholderAPI", new PlaceholderService(this));
    ...
    public void setTrainCartsModule(final TrainCartsModule trainCartsModule) {
        this.trainCartsModule = trainCartsModule;
    }

    public void setRegionModule(final RegionModule regionModule) {
    ...
    public static OpenAudioMcSpigot getInstance() {
        return OpenAudioMcSpigot.instance;
    }
}
