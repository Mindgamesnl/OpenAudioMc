...
public class ConcurrentHeatMap<T, S> {
    ...
    private Consumer<T> deleteConsumer = null;
    ...
    private List<Value> sortedValues() {
        ...
        return new ArrayList<>(data.values()).stream().sorted(Comparator.comparingInt(Value::getScore).reversed()).collect(Collectors.toList());
    }
    ...
    public void forceValue(T value, Instant pingedAt, Integer score) {
        data.put(value, new Value((S) contextFactory.buildContext(), value, pingedAt, score));
    }
    ...
    public class Value {
        ...
        private Instant pingedAt = Instant.now();
        ...
        public Value(final S context, final T value, final Instant pingedAt, final Integer score) {
            this.context = context;
            this.value = value;
        ...
        public void setContext(final S context) {
            this.context = context;
        }
    ...
    public void setDeleteConsumer(final Consumer<T> deleteConsumer) {
