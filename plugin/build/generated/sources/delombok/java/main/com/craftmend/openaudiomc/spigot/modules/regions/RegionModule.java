...
public class RegionModule {
    ...
    private Set<RegionProperties> regionsWithoutWorld = new HashSet<>();
    ...
    public RegionModule(@Nullable AbstractRegionAdapter customAdapter) {
        ...
        OpenAudioMc.getService(MediaService.class).getResetTriggers().add(() -> {
            ...
            worldManagers.forEach((s, worldRegionManager) -> {
                worldRegionManager.dropMediaCache();
            });
        });
    ...
    public Set<RegionProperties> getRegionsWithoutWorld() {
        return this.regionsWithoutWorld;
    }
}
