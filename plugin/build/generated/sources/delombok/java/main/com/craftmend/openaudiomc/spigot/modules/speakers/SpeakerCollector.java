...
public class SpeakerCollector {
    ...
    public Collection<ApplicableSpeaker> getApplicableSpeakers(Location location, boolean safe) {
        ...
        applicableSpeakers.forEach(speaker -> {
            speakers.add(new ApplicableSpeaker(speaker, speaker.getSpeakerType(), Vector3.from(speaker.getLocation())));
        });
        return speakers;
    }
    ...
    public SpeakerCollector(final SpeakerService speakerService) {
