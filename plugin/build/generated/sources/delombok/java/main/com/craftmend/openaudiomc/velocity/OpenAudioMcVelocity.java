...
@Plugin(id = "openaudiomc", name = "OpenAudioMc Bungee Plugin Port for Velocity", version = "6.10.11", authors = {"Mindgamesnl", "fluse1367"}, description = "OpenAudioMc: Proximity voice chat & audio plugin for Minecraft, no mods needed. Supports Bungeecord, Velocity, Spigot & more.", url = "https://openaudiomc.net/")
public class OpenAudioMcVelocity implements OpenAudioInvoker {
    ...
    public String getPluginVersion() {
        return server.getPluginManager().getPlugin("openaudiomc").orElseThrow(() -> new Error("OpenAudioMc Velcoity plugin not found!")).getDescription().getVersion().orElse("null");
    }
    ...
    public static OpenAudioMcVelocity getInstance() {
        return OpenAudioMcVelocity.instance;
    }
    ...
    public VelocityPacketManager getMessageReceiver() {
