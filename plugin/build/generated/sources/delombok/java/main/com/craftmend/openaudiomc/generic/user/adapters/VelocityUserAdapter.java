...
public class VelocityUserAdapter implements User<CommandSource> {
    ...
    public void sendTitle(String title, String subtitle, int fadeIn, int stay, int fadeOut) {
        ...
        sender.showTitle(Title.title(Component.text(translateColors(title)), Component.text(translateColors(title)), Title.Times.of(Duration.ofMillis(fadeIn), Duration.ofMillis(stay), Duration.ofMillis(fadeOut))));
    }
    ...
    public VelocityUserAdapter(final CommandSource sender) {
        this.sender = sender;
    }
}
