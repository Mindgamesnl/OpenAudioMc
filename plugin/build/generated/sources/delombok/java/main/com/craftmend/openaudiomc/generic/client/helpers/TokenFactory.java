...
public class TokenFactory {
    ...
    public ClientAuth build(ClientConnection client) {
        ...
        String staticToken = client.getUser().getName() + ":" + client.getUser().getUniqueId().toString() + ":" + OpenAudioMc.getService(AuthenticationService.class).getServerKeySet().getPublicKey().getValue() + ":" + key;
