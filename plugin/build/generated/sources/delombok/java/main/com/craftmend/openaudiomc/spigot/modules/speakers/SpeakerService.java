...
public class SpeakerService extends Service {
    ...
    public void onEnable() {
        openAudioMcSpigot.registerEvents(new SpeakerSelectListener(this), new SpeakerCreateListener(openAudioMcSpigot, this), new SpeakerDestroyListener(OpenAudioMc.getInstance(), this));
