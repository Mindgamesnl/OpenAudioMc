    ...
    public void onExecute(User sender, String[] args) {
        try {
            ...
            for (Channel channel : channels) {
                ...
                sender.sendMessage(Platform.translateColors(StorageKey.MESSAGE_VOICE_CHANNEL_LIST_ITEM.getString().replace("{channel}", channel.getName()).replace("{participants}", readableOccupants.toString()).replace("{type}", channel.getReadableType())));
            }
