...
public class BungeeCommandModule extends Service implements Listener {
    ...
    public void onEnable() {
        ...
        commandService.registerSubCommands(CommandContext.OPENAUDIOMC, new BungeeRegionCommand(), new BungeeSpeakerCommand(), new BungeeShowCommand(), new BungeeAliasCommand(), new BungeeVoiceCommand(), new BungeePlaylistCommand());
    }
