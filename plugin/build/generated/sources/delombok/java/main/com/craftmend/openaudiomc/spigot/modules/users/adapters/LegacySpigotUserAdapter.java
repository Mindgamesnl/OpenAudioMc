...
public class LegacySpigotUserAdapter implements User<CommandSender> {
    ...
    public void sendClickableCommandMessage(String msgText, String hoverMessage, String command) {
        ...
        TextComponent message = new TextComponent(translateColors(Objects.requireNonNull(msgText)));
        TextComponent[] hover = new TextComponent[] {new TextComponent(translateColors(hoverMessage))};
    ...
    public LegacySpigotUserAdapter(final CommandSender sender) {
        this.sender = sender;
    }
}
