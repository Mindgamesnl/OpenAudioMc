...
public class VoiceApiConnection {
    ...
    public int getUsedSlots() {
        return (int) OpenAudioMc.getService(NetworkingService.class).getClients().stream().filter(client -> client.getRtcSessionManager().isReady()).count();
    }
    ...
    public void setStatus(final VoiceApiStatus status) {
        this.status = status;
    }
