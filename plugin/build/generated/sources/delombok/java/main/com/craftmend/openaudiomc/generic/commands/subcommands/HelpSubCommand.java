...
public class HelpSubCommand extends SubCommand {
    ...
    private String headerMessage = "Welcome to OpenAudioMc! Please click the sub command you need help with.";
    ...
    public void onExecute(User<?> sender, String[] args) {
        ...
        if (this.useHelpTrail) message(sender, "For more personal help or other questions, please visit https://openaudiomc.net/docs");
    }
