...
public class BungeeUtils {
    ...
    public static boolean areEncodersReady(ProxiedPlayer player) {
        try {
            ...
            return channelPipelineGetEncoder.invoke(userChannelPipeline, MinecraftDecoder.class) != null && channelPipelineGetEncoder.invoke(userChannelPipeline, MinecraftEncoder.class) != null && channelPipelineGetEncoder.invoke(serverChannelPipeline, MinecraftDecoder.class) != null && channelPipelineGetEncoder.invoke(serverChannelPipeline, MinecraftEncoder.class) != null;
