...
public class Channel implements VoiceChannel {
    ...
    private boolean requiresPermissionToSee = false;
    ...
    public void setRequiresPermissionToSee(final boolean requiresPermissionToSee) {
        this.requiresPermissionToSee = requiresPermissionToSee;
    }

    public boolean isRequiresPermissionToSee() {
        return this.requiresPermissionToSee;
    }
