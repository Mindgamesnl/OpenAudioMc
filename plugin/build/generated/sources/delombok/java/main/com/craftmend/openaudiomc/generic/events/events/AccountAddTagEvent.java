...
public class AccountAddTagEvent extends BaseEvent {
    ...
    public String toString() {
        return "AccountAddTagEvent(addedTag=" + this.getAddedTag() + ")";
    }

    @Override
    public boolean equals(final Object o) {
        if (o == this) return true;
        if (!(o instanceof AccountAddTagEvent)) return false;
        final AccountAddTagEvent other = (AccountAddTagEvent) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof AccountAddTagEvent;
    }
    ...
    public AccountAddTagEvent(final CraftmendTag addedTag) {
        this.addedTag = addedTag;
    }
}
