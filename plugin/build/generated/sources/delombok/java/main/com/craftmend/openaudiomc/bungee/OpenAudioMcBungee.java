...
public class OpenAudioMcBungee extends Plugin implements OpenAudioInvoker {
    ...
    public void onEnable() {
        ...
        try {
            ...
            openAudioMc.getServiceManager().getService(BungeeDependencyService.class).ifPluginEnabled("LiteBans", new LitebansIntegration());
    ...
    public static OpenAudioMcBungee getInstance() {
        return OpenAudioMcBungee.instance;
    }
