...
public class OpenAudioMc {
    ...
    public OpenAudioMc(OpenAudioInvoker invoker) throws Exception {
        ...
        serviceManager.loadServices(RuntimeDependencyService.class, EventService.class // platform agnostic event manager
        );
        // setup
        ...
        serviceManager.loadService(BackupService.class // handles backups
        );
        // migrate old config and data files between versions
        new MigrationWorker().handleMigrations();
        // handle modules
        serviceManager.loadService(ModuleLoaderService.class // download, save and use external jar modules
        );
        ...
        serviceManager.loadServices(DatabaseService.class,  // player and profile storage
    ...
    public static OpenAudioMc getInstance() {
        return OpenAudioMc.instance;
    }

    public static Gson getGson() {
        return OpenAudioMc.gson;
    }
}
