...
public class ClientConnection implements Authenticatable, Client, Serializable, com.craftmend.openaudiomc.api.interfaces.Client {
    ...
    public void onConnect() {
        ...
        if (OpenAudioMc.getInstance().getPlatform() == Platform.SPIGOT && OpenAudioMcSpigot.getInstance().getProxyModule().getMode() == OAClientMode.NODE) return;
    ...
    public void setDataCache(final ClientDataStore dataCache) {
