				...
				if (sender.hasPermission("openaudio.admin")) {
					if (args.length > 0) {
							if (args[0].equalsIgnoreCase("debug")) {
								...
								sender.sendMessage(me.mindgamesnl.openaudiomc.main.config.Config.Project_Chat_Name_Prefix_Color + " Reloading config...");
								me.mindgamesnl.openaudiomc.main.config.Config.Load();
								sender.sendMessage(me.mindgamesnl.openaudiomc.main.config.Config.Project_Chat_Name_Prefix_Color + " Reloading complete");
