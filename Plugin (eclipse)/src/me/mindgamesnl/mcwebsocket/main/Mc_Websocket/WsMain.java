...
public class WsMain extends WebSocketServer {
    ...
    public void onMessage(WebSocket conn, String message) {
      //  Bukkit.getLogger().info(me.mindgamesnl.mcwebsocket.main.config.Config.Chat_Header + "Websocket packet ontvangen! - " + conn + ":" + message);
        ...
        if (jsonObject.get("command").getAsString().equalsIgnoreCase("connect")) {
            ...
            if (me.mindgamesnl.mcwebsocket.main.Mc_Websocket.Main.getPL().getConfig().getString("config.startsound").equalsIgnoreCase("none") || me.mindgamesnl.mcwebsocket.main.Mc_Websocket.Main.getPL().getConfig().getString("config.startsound").equalsIgnoreCase("off")) {
            } else {
    ...
    public static void runServer() throws InterruptedException, IOException {
        ...
        int port = Integer.parseInt(me.mindgamesnl.mcwebsocket.main.Mc_Websocket.Main.getPL().getConfig().getString("config.ws_host_port"));
        s = new WsMain(port);
        s.start();
    }
