				...
				if (sender.hasPermission("openaudio.admin")) {
					if (args.length > 0) {
							if (args[0].equalsIgnoreCase("debug")) {
								...
								sender.sendMessage(me.mindgamesnl.mcwebsocket.main.config.Config.Project_Chat_Name_Prefix_Color + " Message to: " + args[1]);
								...
								sender.sendMessage(me.mindgamesnl.mcwebsocket.main.config.Config.Project_Chat_Name_Prefix_Color + " Please enter the following information in the OpenAudioMc Setup");
								sender.sendMessage(" " + ChatColor.RED + "-" + ChatColor.YELLOW + " OpenAudio Host: " + ChatColor.GRAY + me.mindgamesnl.mcwebsocket.main.Mc_Websocket.Main.getPL().getConfig().getString("config.ws_host_adress"));
								sender.sendMessage(" " + ChatColor.RED + "-" + ChatColor.YELLOW + " OpenAudio Port: " + ChatColor.GRAY + me.mindgamesnl.mcwebsocket.main.Mc_Websocket.Main.getPL().getConfig().getString("config.ws_host_port"));
								...
								sender.sendMessage(me.mindgamesnl.mcwebsocket.main.config.Config.Project_Chat_Name_Prefix_Color + " Reloading config...");
								me.mindgamesnl.mcwebsocket.main.config.Config.Load();
								sender.sendMessage(me.mindgamesnl.mcwebsocket.main.config.Config.Project_Chat_Name_Prefix_Color + " Reloading complete");
								...
								if (args[1].equalsIgnoreCase("start")) {
									me.mindgamesnl.mcwebsocket.main.config.Config.sream_live = true;
									me.mindgamesnl.mcwebsocket.main.config.Config.stream_source = args[2];
									for (Player p : Bukkit.getOnlinePlayers()) {
										WsSender.Send_Ws_Packet_To_Client(Bukkit.getPlayerExact(p.getName()), "{\"command\":\"startlive\",\"line\":\"loop\",\"src\":\"" + me.mindgamesnl.mcwebsocket.main.config.Config.stream_source + "\"}");
									}
								}
								
								if (args[1].equalsIgnoreCase("stop")) {
									me.mindgamesnl.mcwebsocket.main.config.Config.sream_live = false;
									for (Player p : Bukkit.getOnlinePlayers()) {
								...
								if (args.length == 1) {
									...
									sender.sendMessage("    ");
									sender.sendMessage("     ");
									sender.sendMessage("========" + me.mindgamesnl.mcwebsocket.main.config.Config.Project_Chat_Name_Prefix_Color + " (1/5)");
									...
									sender.sendMessage("    ");
									sender.sendMessage("     ");
									sender.sendMessage("========" + me.mindgamesnl.mcwebsocket.main.config.Config.Project_Chat_Name_Prefix_Color + " (2/5)");
									...
									sender.sendMessage("    ");
									sender.sendMessage("     ");
									sender.sendMessage("========" + me.mindgamesnl.mcwebsocket.main.config.Config.Project_Chat_Name_Prefix_Color + " (3/5)");
									...
									sender.sendMessage("    ");
									sender.sendMessage("     ");
									sender.sendMessage("========" + me.mindgamesnl.mcwebsocket.main.config.Config.Project_Chat_Name_Prefix_Color + " (4/5)");
									...
									sender.sendMessage(" " + ChatColor.RED + "-" + ChatColor.YELLOW + " /openaudio reload " + ChatColor.GRAY + "Reload the config.");
									...
									sender.sendMessage("    ");
									sender.sendMessage("     ");
									sender.sendMessage("========" + me.mindgamesnl.mcwebsocket.main.config.Config.Project_Chat_Name_Prefix_Color + " (5/5)");
