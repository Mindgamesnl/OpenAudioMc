...
export class PlatformSelection extends React.Component {
  ...
  render() {
    const btnClass = 'mx-4 w-2/3 px-5 py-2.5 text-white bg-gray-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium common-rounded-top common-rounded-bottom text-sm text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800';
