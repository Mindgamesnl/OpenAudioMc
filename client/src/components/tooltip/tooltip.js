            ...
            <div>
                ...
                <span className="focus:outline-none focus:ring-gray-300 rounded-full focus:ring-offset-2 focus:ring-2 focus:bg-gray-200 absolute">
                    <div
                        ...
                        <svg className="absolute left-0 -ml-7 bottom-0 top-0 h-full" width="9px" height="16px"
                        ...
                        <div className="flex justify-end">
                            <button onClick={this.close} className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:bg-indigo-400 focus:outline-none focus:text-white bg-white transition duration-150 ease-in-out focus:outline-none hover:bg-gray-200 rounded text-indigo-700 px-5 py-1 text-xs">
...
Tooltip.defaultProps = {
    title: "Tooltip title",
    text: "I am the text that will be displayed in the tooltip when you hover over the title.",
    visible: true
};
