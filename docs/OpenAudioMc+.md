OpenAudioMc-Plus (or OpenAudioMc+ for short) is a free online admin panel for server administrators to configure, customize and hookinto the OpenAudioMc client.
