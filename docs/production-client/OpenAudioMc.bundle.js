...
!function (t) {
          ...
          r.json().then(function (r) {
            function i(t, e) {
              ...
              d += t.outerHTML;
                ...
                g = i(o.accentColor, 40);if (document.documentElement.style.setProperty("--border-color-normal", m), document.documentElement.style.setProperty("--border-color-light", g), t.getUserInterfaceModule().changeColor("#2c78f6", o.accentColor), "" != o.startSound && (t.getMediaManager().startSound = o.startSound), "default" !== c) {
  ...
  window.onload = function () {
    if (navigator.vendor && -1 < navigator.vendor.indexOf("Apple") && navigator.userAgent && -1 == navigator.userAgent.indexOf("CriOS") && -1 == navigator.userAgent.indexOf("FxiOS")) return void (window.location.href = "https://help.openaudiomc.net/browsers.html");new ft().initialize().then(function (t) {
      return console.log(t), null == t ? (r(et.BAD_AUTH), void R("A faulty login attempt was done at " + window.location.host, "Steve")) : (null != t && null != t.name && (document.getElementById("in-game-name").innerText = t.name, pe = new Me()), document.body.addEventListener("click", q), void (.5 <= Math.random() && v(ht.SERVER_STATUS + t.name).then(function (t) {
        t.json().then(function (t) {
