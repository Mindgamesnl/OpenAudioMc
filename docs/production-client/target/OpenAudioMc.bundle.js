...
!function (e) {
  ...
  function r(e, t, n) {
    ...
    M(Ee.ERROR_REPORTING, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ playerName: t, message: "build 596: " + e }) }).then(function (e) {
  ...
  n.d(t, "OpenAudioEnv", function () {
    ...
    return vt;
  });var mt = { build: "596", compiler: "Mindgamesnl", platform: "Production", environment: "Linux", isProd: JSON.parse("true"), envDescription: "default-prod" };window.debugHooks = {}, u(function () {
