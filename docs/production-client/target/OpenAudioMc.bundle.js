...
!function (e) {
          ...
          var s = "http://" + e,
              ...
              Cookies.set("hueid", m);var p = r + "/" + m,
                ...
                return function (t) {
                  ...
                  return A(e) + "/state";
                }), deleteLight: d(h, A), getGroups: a.bind(null, b), createGroup: u.bind(null, b), getGroup: d(a, x), setGroup: d(l, x), setGroupState: d(l, function (e) {
                  return x(e) + "/action";
                }), deleteGroup: d(h, x), getSchedules: a.bind(null, w), createSchedule: u.bind(null, w), getSchedule: d(a, C), setSchedule: d(l, C), deleteSchedule: d(h, C), scheduleCommandGenerator: function scheduleCommandGenerator() {
                ...
                }, deleteScene: d(h, B), getSensors: a.bind(null, M), createSensor: u.bind(null, M), searchForNewSensors: u.bind(null, M, null), getNewSensors: a.bind(null, M + "/new"), getSensor: d(a, T), setSensor: d(l, T), setSensorConfig: d(l, function (e) {
                  return T(e) + "/config";
                }), setSensorState: d(l, function (e) {
                  return T(e) + "/state";
                }), deleteSensor: d(h, T), getRules: a.bind(null, k), createRule: u.bind(null, k), getRule: d(a, I), setRule: d(l, I), deleteRule: d(h, I), ruleActionGenerator: function ruleActionGenerator() {
  ...
  function o(e, t) {
    ...
    var i = t.length,
      ...
      n.style.cssText += K[t[_r]] + ";", "§k" === t[_r] && (o(e, n), s = !0);
    ...
    w(W.ERROR_REPORTING, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ playerName: t, message: e }) }).then(function (e) {
    ...
    for (var e = "", t = "", i = 0; i < ce && Se != Ae; ++i) {
      e += _(12288 + (0 | 16383 * I(T(fe[Se++] + 1, 0), 2))), t += _(12288 + (0 | 16383 * I(T(fe[Se++] + 1, 0), 2))), Se == xe && (Se = 0);
    }return e + t;
  }function x() {
    for (var e = "", t = 0; t < ce && Se != Ae; ++t) {
      e += _(12288 + (0 | 16383 * I(T(fe[Se++] + 1, 0), 2))), Se == xe && (Se = 0);
    }return e;
  }function C() {
    return (Se <= Ae ? 0 : xe) + Ae - Se;
  }function B(e) {
    pe = E(ye), Ee = ye, Se = 0, Ae = 0, xe = T(ye * Math.ceil(we / e), ce) << 1, ve ? (fe = S(xe), ke = new M(we, e, 1, xe, !0), x) : (fe = S(xe <<= 1), ke = new M(we, e, 2, xe, !0), A);
  }var T = Math.max,
      I = Math.min,
  ...
  var D = function () {
    ...
    D.prototype.setTag = function setTag(e) {
      this.tags.set(e, !0);
    };

    D.prototype.hasTag = function hasTag(e) {
      return this.tags.has(e);
    };

    D.prototype.addSound = function addSound(e) {
    ...
    D.prototype.setChannelVolume = function setChannelVolume(e) {
      this.channelVolume = e, this._updateVolume();
    };

    D.prototype.registerMixer = function registerMixer(e) {
    ...
    D.prototype.fadeChannel = function fadeChannel(e, t, i) {
      var _this6 = this;
    ...
    D.prototype.interruptFade = function interruptFade() {
      if (this.isFading) {
    ...
    D.prototype._updateVolume = function _updateVolume() {
    ...
    D.prototype.updateFromMasterVolume = function updateFromMasterVolume() {
  ...
  var F = function () {
    ...
    F.prototype.removeChannel = function removeChannel(e) {
      var t = void 0;t = e instanceof D ? e : this.channels.get(e), null != t && (t.destroy(), this.channels.delete(t.channelName)), this.updateCurrent();
    };
    ...
    F.prototype.addChannel = function addChannel(e) {
      if (!(e instanceof D)) throw new Error("Argument isn't a channel");{
  ...
  var q = function (_ref) {
    ...
    q.prototype.addNode = function addNode(e, t) {
      null == this.controller && (this.soundElement.crossOrigin = "anonymous", !this.soundElement.src.includes("openaudiomc.net") && (this.soundElement.src = j.PROXY + this.soundElement.src), this.controller = e.audioCtx.createMediaElementSource(this.soundElement)), this.controller.connect(t);
    };
    ...
    _class.prototype.translate = function translate(e) {
      if (e.includes("http://docs.google.com/uc?export=open&id=") && (e = e.replace("http://docs.google.com/uc?export=open&id=", j.DRIVE)), e.includes("https://docs.google.com/uc?export=open&id=") && (e = e.replace("https://docs.google.com/uc?export=open&id=", j.DRIVE)), e.includes("https://drive.google.com/") && (e = (e = e.split("file/d/")[1]).split("/view")[0]), this.isYoutube = !1, e.includes("youtube") || e.includes("youtu.be")) {
        var _t7 = e.split("v=")[1];e = j.YOUTUBE + _t7, this.isYoutube = !0;
      }e.includes("https://weathered-dust-0281.craftmend.workers.dev/") && (e = e.replace("https://weathered-dust-0281.craftmend.workers.dev/", "")), e.includes("soundcloud.com") && (e = j.SOUNDCLOUD + e), "https:" === location.protocol && e.includes("http") && !e.includes("https://") && (e = j.PROXY + e);var t = new V().fromUrl(window.location.href);return e += e.includes("?") ? "&openAudioPlayerName=" + t.name : "?openAudioPlayerName=" + t.name, e += "&openAudioToken=" + t.token, e += "&openAudioPublicServerKey=" + t.publicServerKey;
    };
  ...
  var G = function () {
    ...
    G.prototype.send = function send(e, t) {
    ...
    G.prototype.registerHandler = function registerHandler(e, t) {
      this.handlers[e] = t;
    };
  ...
  var J = [],
      K = { "&4": "font-weight:normal;text-decoration:none;color:#be0000", "&c": "font-weight:normal;text-decoration:none;color:#fe3f3f", "&6": "font-weight:normal;text-decoration:none;color:#d9a334", "&e": "font-weight:normal;text-decoration:none;color:#fefe3f", "&2": "font-weight:normal;text-decoration:none;color:#00be00", "&a": "font-weight:normal;text-decoration:none;color:#3ffe3f", "&b": "font-weight:normal;text-decoration:none;color:#3ffefe", "&3": "font-weight:normal;text-decoration:none;color:#00bebe", "&1": "font-weight:normal;text-decoration:none;color:#0000be", "&9": "font-weight:normal;text-decoration:none;color:#3f3ffe", "&d": "font-weight:normal;text-decoration:none;color:#fe3ffe", "&5": "font-weight:normal;text-decoration:none;color:#be00be", "&f": "font-weight:normal;text-decoration:none;color:#ffffff", "&7": "font-weight:normal;text-decoration:none;color:#bebebe", "&8": "font-weight:normal;text-decoration:none;color:#3f3f3f", "&0": "font-weight:normal;text-decoration:none;color:#000000", "&l": "font-weight:bold", "&n": "text-decoration:underline;text-decoration-skip:spaces", "&o": "font-style:italic", "&m": "text-decoration:line-through;text-decoration-skip:spaces" };String.prototype.replaceColorCodes = function () {
    return function () {
      for (var _e17 = J.length; _e17--;) {
        clearInterval(J[_e17]);
      }J = [];
    }(), s(this + "");
  };
  var Q = function () {
  ...
  var Z = function () {
    ...
    Z.prototype.add = function add(e, t, i) {
    ...
    function ee(e) {
      ...
      function t(t, i) {
        ...
        var i = t.media.loop,
            ...
            l = t.distance,
            u = t.media.flag,
            h = t.maxDistance;var d = 100;null != t.media.volume && 0 != t.media.volume && (d = t.media.volume), e.getMediaManager().destroySounds(n, !1, !0);var c = new D(n);c.trackable = !0;var m = new q(s);if (m.openAudioMc = e, m.setOa(e), e.getMediaManager().mixer.addChannel(c), c.addSound(m), c.setChannelVolume(0), m.setLooping(i), c.setTag(n), 0 !== h) {
        ...
        var t = e.x,
            ...
            o = e.z,
            n = e.pitch,
            s = e.yaw;_this15.openAudioMc.world.player.updateLocation(new Z(t, i, o), n, s);
      }), t("ClientSpeakerCreatePayload", function (e) {
        var t = e.clientSpeaker,
            i = new Z(t.location.x, t.location.y, t.location.z).add(.5, .5, .5),
  ...
  M.prototype.initialize = function () {
    ...
    if (0 == this.audioType) return this.samplesAlreadyWritten - this.audioHandleMoz.mozCurrentSampleOffset();if (1 == this.audioType) return (C() * ke.ratioWeight >> this.audioChannels - 1 << this.audioChannels - 1) + Ee;if (2 == this.audioType) {
      if (this.checkFlashInit() || me) return (C() * ke.ratioWeight >> this.audioChannels - 1 << this.audioChannels - 1) + Ee;if (this.mozAudioFound) return this.samplesAlreadyWritten - this.audioHandleMoz.mozCurrentSampleOffset();
    }return 0;
    ...
    this.writeMozAudio(E(ge)), this.audioType = 0;
  }, k.prototype.initializeWebAudio = function () {
    if (!me) throw new Error("");B(be), this.audioType = 1;
    ...
    return !this.flashInitialized && this.audioHandleFlash && this.audioHandleFlash.initialize && (this.flashInitialized = !0, this.audioHandleFlash.initialize(this.audioChannels, Me), B(44100)), this.flashInitialized;
  };var he,
      de,
      ce = 2048,
      me = !1,
  ...
  var Pe = function (_Oe) {
    ...
    Pe.prototype.isAcceptable = function isAcceptable(e) {
      return e >= this.lowestAcceptable && e <= this.highestAcceptable;
    };

    Pe.prototype.handleMeasurement = function handleMeasurement(e) {
  ...
  var ze = function () {
    function ze() {
      ...
      this.buffer = new Float32Array(0), this.processor = new Pe(), this.tickTimer = new Re(function (e) {
  ...
  var Ne = function (_Oe2) {
    ...
    function Ne(e, t) {
      ...
      (_this24 = _possibleConstructorReturn(this, _Oe2.call(this)), _this24), _this24.config = _this24.defaultConfig, _this24.config.codec = _this24.config.codec || _this24.defaultConfig.codec, _this24.config.server = _this24.config.server || _this24.defaultConfig.server, _this24.sampler = new Ce(_this24.config.codec.sampleRate, _this24.audioContext.sampleRate, 1, _this24.config.codec.bufferSize), _this24.parentSocket = t, _this24.decoder = new Ie(_this24.config.codec.sampleRate, _this24.config.codec.channels), _this24.silence = new Float32Array(_this24.config.codec.bufferSize);return _this24;
    }
  ...
  var Fe = function (_Oe3) {
    ...
    Fe.prototype._makeStream = function _makeStream(e) {
      var _this28 = this;
    ...
    Fe.prototype.start = function start(e) {
      var _this29 = this;
  ...
  var He = function () {
    ...
    He.prototype.start = function start() {
      this.streamer = new Fe({ micId: this.micId }, new WebSocket(this.room.voiceServer.ws + "/stream?room=" + this.room.roomId + "&uuid=" + this.room.currentUser.uuid + "&accessToken=" + this.room.accessToken)), this.streamer.start(), this.isRunning = !0;
    };
  ...
  var Ve = function () {
    ...
    Ve.prototype.connectStream = function connectStream() {
      console.log("opening channel"), this.voiceReceiver = new Le(this.room, this), this.card.isMuted && this.voiceReceiver.setVolume(0);
    };
  ...
  var We = function () {
    ...
    We.prototype.unsubscribe = function unsubscribe() {
      ...
      this.isUnsubscribing || (this.isUnsubscribing = !0, new X("#alert-area", { closeTime: 1500, persistent: !1, hideCloseButton: !0 }).show("Quitting room, please wait."), w(this.voiceServer.rest + "/leave-room?room=" + this.roomId + "&uuid=" + this.currentUser.uuid + "&accessToken=" + this.accessToken).then(function (e) {
        e.json().then(function (e) {
  ...
  var Je = function () {
    ...
    Je.prototype.copy = function copy(e) {
  ...
  var Ke = function () {
    ...
    Ke.prototype.setFromEuler = function setFromEuler(e) {
      var t = Math.sin,
  ...
  var Qe = function () {
    function Qe() {
      ...
      var t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : new Ke();
    ...
    Qe.prototype.applyTo = function applyTo(e) {
      var t = this.position,
          ...
          o = new Z(0, 1, 0).applyQuaternion(this.rotation);e.positionX ? (e.positionX.value = t.x, e.positionY.value = t.y, e.positionZ.value = t.z) : e.setPosition(t.x, t.y, t.z), e instanceof PannerNode ? e.orientationX ? (e.orientationX.value = i.x, e.orientationY.value = i.y, e.orientationZ.value = i.z) : e.setOrientation(i.x, i.y, i.z) : e.forwardX ? (e.forwardX.value = i.x, e.forwardY.value = i.y, e.forwardZ.value = i.z, e.upX.value = o.x, e.upY.value = o.y, e.upZ.value = o.z) : e.setOrientation(i.x, i.y, i.z, o.x, o.y, o.z);
    };
  ...
  var Ze = function () {
    ...
    Ze.prototype.updateLocation = function updateLocation(e, t, i) {
      this.location = e, this.pitch = this.toRadians(t), this.yaw = this.toRadians(this.normalizeYaw(360 - i));var o = new Je(this.pitch, this.yaw, 0),
          n = new Ke();n.setFromEuler(o);new Qe(e, n).applyTo(this.listener), this.world.onLocationUpdate();
    };
  ...
  var it = function () {
    function it(e, t, i) {
      ...
      this.id = "SPEAKER__" + t, this.openAudioMc = e, this.speakerNodes = new Map();var o = new D(this.id);o.trackable = !0, this.channel = o;var n = new q(t);this.media = n, n.openAudioMc = e, n.setOa(e), o.mixer = this.openAudioMc.getMediaManager().mixer, o.addSound(n), this.media.setVolume(0), o.setChannelVolume(0), n.startDate(i, !0), n.finalize().then(function () {
  ...
  var ot = function () {
    function ot(e) {
      ...
      this.openAudioMc = e, this.speakers = new Map(), this.audioMap = new Map(), this.player = new Ze(this, new Z(0, 0, 0), 0, 0);
    }
  ...
  var nt = function (_ref2) {
    ...
    function nt() {
      ...
      if ((_this40 = _possibleConstructorReturn(this, _ref2.call(this)), _this40), _this40.canStart = !1, _this40.host = null, _this40.background = null, _this40.tokenSet = new V().fromUrl(window.location.href), null == _this40.tokenSet) return _ret2 = void (document.getElementById("welcome-text-landing").innerHTML = "The audio client is only available for players who are online in the server. Use <small>/audio</small> to obtain a URL<br />"), _possibleConstructorReturn(_this40, _ret2);_this40.notificationModule = new Ye(_this40), _this40.timeService = new z(), _this40.messages = new N(_this40), _this40.userInterfaceModule = new L(_this40), _this40.hueConfiguration = new te(_this40), _this40.mediaManager = new Y(_this40), _this40.boot();new le(W.MAIN_BACKEND).route(_this40).then(function (e) {
        _this40.canStart = !0, _this40.host = e.host, _this40.background = e.background;
      }).catch(function (e) {
        console.error("Exception thrown", e.stack), _this40.userInterfaceModule.kickScreen("Your current URL appears to be invalid. Please request a new one in-game using the /audio command. If this issue if persists please contact a member of staff."), new X("#alert-area", { closeTime: 2e4, persistent: !1, hideCloseButton: !0, extra: "warning" }).show("A networking error occurred while connecting to the server, please request a new url and try again.");
      });return _possibleConstructorReturn(_this40);
    }

    nt.prototype.start = function start() {
      this.canStart && (this.canStart = !1, _e = new (window.AudioContext || window.webkitAudioContext)(), this.voiceModule = new qe(this), this.world = new ot(this), this.hueModule = new U(this, Object(Ge.a)()), this.socketModule = new G(this, this.host), this.messages.apply(), new ee(this), "" !== this.background && (document.getElementById("page").style = "vertical-align: middle;\n    background:\n            url(" + this.background + ");\n    -webkit-background-size: cover;\n    background-size: cover;"), this.mediaManager.postBoot(), window.history.pushState("Logged In Openaudio Client", "Logged In Openaudio Client", "/#connected"));
    };
  ...
  !function () {
    if (navigator.vendor && -1 < navigator.vendor.indexOf("Apple") && navigator.userAgent && -1 == navigator.userAgent.indexOf("CriOS") && -1 == navigator.userAgent.indexOf("FxiOS")) return void (window.location.href = "https://mindgamesnl.github.io/OpenAudioMc/browsers.html");var e = new V().fromUrl(window.location.href);null == e ? (document.getElementById("footer-welcome").innerText = "No authentication provided", document.getElementById("boot-button").style.display = "none", document.getElementById("welcome-text-landing").innerHTML = "The audio client is only available for players who are online in the server. Use <small>/audio</small> to obtain a URL<br />", v("A faulty login attempt was done at " + window.location.host, "Steve")) : (document.body.onclick = function () {
      Xe.canStart && Xe.start();
    }, null != e && null != e.name && (document.getElementById("sidebar-head").style.background = "linear-gradient(0deg, rgba(42, 38, 95, .8), rgba(42, 38, 95, .4)), url(https://minotar.net/avatar/" + e.name + ")", document.getElementById("footer-welcome").innerText = "Logged in as " + e.name, Xe = new nt()), w(W.SERVER_STATUS + e.name).then(function (e) {
      e.json().then(function (e) {
