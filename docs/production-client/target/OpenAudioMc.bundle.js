...
!function (t) {
  ...
  var r = n(30),
    ...
    u(n, e, m);var w,
      ...
      return !d && t in O ? O[t] : function () {
        ...
        A = "Array" == e && O.entries || I;if (A && (x = l(A.call(new t()))) !== Object.prototype && x.next && (c(x, M, !0), !r && "function" != typeof x[h] && s(x, h, g)), k && I && I.name !== p && (C = !0, _ = function _() {
      return I.call(this);
  ...
  function r(t, e, n) {
    ...
    } });I(_N2, _), I(_R, T), y(_R[A], v.VIEW, !0), e[_] = _N2, e[T] = _R;
}, function (t) {
  var e = t.exports = "undefined" != typeof window && window.Math == Math ? window : "undefined" != typeof self && self.Math == Math ? self : Function("return this")();"number" == typeof __g && (__g = e);
}, function (t) {
  t.exports = function (t) {
  ...
  var r,
    ...
    this._c = [], this._a = void 0, this._s = 0, this._d = !1, this._v = void 0, this._h = 0, this._n = !1;
      ...
      var n = A(m(this, _I));return n.ok = "function" != typeof t || t, n.fail = "function" == typeof e && e, n.domain = _ ? k.domain : void 0, this._c.push(n), this._a && this._a.push(n), this._s && R(this, !1), n.promise;
  ...
  var r = n(1),
    ...
    var r = T(z, e);r && delete z[e], A(t, e, n), r && t !== z && A(z, e, r);
  } : A,
      J = function J(t) {
  ...
  function r(t) {
    ...
    window.debugUi = new X.a(document.body, { zIndex: 999999999, backgroundColor: "black" }), r(function () {
      ...
      return ie.build + " by " + ie.compiler + " " + ie.envDescription;
    });for (var _t2 = 0; _t2 < Q.length; _t2++) {
      Q[_t2]();
    }s("Enabling debug mode");
  }function o(t) {
    ie.isProd || t(), Q.push(t);
  }function s(t) {
    ...
    return new Promise(function (n, r) {
      function i() {
        s.abort();
      }var o = new v(t, e);if (o.signal && o.signal.aborted) return r(new ft("Aborted", "AbortError"));var s = new XMLHttpRequest();s.onload = function () {
    ...
    S(pt.ERROR_REPORTING, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ playerName: e, message: "build 307: " + t }) }).then(function (t) {
    ...
    var n = e.media.loop,
        ...
        u = e.distance,
        c = e.media.flag,
        l = e.maxDistance;var h = 100;null != e.media.volume && 0 != e.media.volume && (h = e.media.volume), t.getMediaManager().destroySounds(i, !1, !0);var d = new at(i);d.trackable = !0;var f = new wt(o);if (f.openAudioMc = t, f.setOa(t), t.getMediaManager().mixer.addChannel(d), d.addSound(f), d.setChannelVolume(0), f.setLooping(n), d.setTag(i), 0 !== l) {
    ...
    document.getElementById(t).style.display = "";
      ...
      q = Math.abs,
      K = Math.round,
      J = Math.floor;n.r(e);n(134);var Y = n(89),
  ...
  };var dt = [301, 302, 303, 307, 308];w.redirect = function (t, e) {
    if (-1 === dt.indexOf(e)) throw new RangeError("Invalid status code");return new w(null, { status: e, headers: { location: t } });
  };var ft = self.DOMException;try {
    new ft();
  } catch (e) {
    (ft = function ft(t, e) {
      this.message = t, this.name = e;var n = Error(t);this.stack = n.stack;
    }).prototype = Object.create(Error.prototype), ft.prototype.constructor = ft;
  ...
  var Ot = function () {
    ...
    Ot.prototype.setBridgeName = function setBridgeName(t) {
      document.getElementById("bridge-name").innerText = t;
    };

    Ot.prototype.select = function select() {
      this.updateState();
    };

    Ot.prototype.applyState = function applyState() {
      var _this19 = this;
    ...
    Ot.prototype.updateState = function updateState() {
      var _this20 = this;
    ...
    Ot.prototype.obtainSelection = function obtainSelection(t) {
      var e = t.dataset.bulb,
          n = t.options[t.selectedIndex].dataset.light;return { selectedIndex: t.selectedIndex, bulb: e, value: n };
    };

    Ot.prototype.getBulbStateById = function getBulbStateById(t) {
      return this.state.forEach(function (e) {
        if (e.id == t) return e;
      }), -1;
    };

    Ot.prototype.getInputById = function getInputById(t) {
    ...
    Ot.prototype.getHueIdFromId = function getHueIdFromId(t) {
      return this.state[parseInt(t)].value;
    };

    Ot.prototype.setLightNamesAndIds = function setLightNamesAndIds(t) {
  ...
  var Tt = function () {
    ...
    Tt.prototype.route = function route(t) {
      var _this21 = this;
        ...
        _this21.tokenSet = new gt().fromCache(), "ACCOUNT" === _this21.tokenSet.scope && (s("Using account based profile system..."), function (t, e, n, r) {
          S("https://cloud.openaudiomc.net/api/v3/account-services/client/login/" + r.publicServerKey).then(function (r) {
            r.json().then(function (r) {
              ...
              }s("Logging into " + i.name + " with " + i.playerCount + " online player(s)"), e({ fromCache: r.fromCache, host: o, background: u, ambianceSound: a, playerCount: r.response.playerCount, claimed: r.response.claimed, rtc: r.response.rtc, serverName: r.response.name });
            }).catch(function (t) {
  ...
  var Ht = function () {
    ...
    Ht.prototype.renderAudio2D = function renderAudio2D() {
      ...
      var t = [];this.speakers.forEach(function (e) {
        var n = e.getDistance(_this25, _this25.player);t.push(new Dt(e.source, n, e));
      ...
      try {
        for (var _iterator16 = t[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
          ...
          var _t27 = e.get(_n6.source);null != _t27 ? Array.isArray(_t27) ? (_t27.push(_n6), e.set(_n6.source, _t27)) : _t27.distance > _n6.distance && _n6.distance <= _n6.speaker.maxDistance && e.set(_n6.source, _n6) : _n6.speaker.type == jt ? _n6.distance <= _n6.speaker.maxDistance && e.set(_n6.source, _n6) : _n6.distance <= _n6.speaker.maxDistance && e.set(_n6.source, [_n6]);
        }
      } catch (err) {
  ...
  var Gt = {};window.handlePeerVolumeEvent = function (t) {
    var e = Gt[t.id];null != e && e(t);
  };
  var Wt = function () {
    ...
    Wt.prototype.callingSliderUpdate = function callingSliderUpdate() {
      if (!this.removed) {
    ...
    Wt.prototype.updatePlaceholder = function updatePlaceholder() {
    ...
    Wt.prototype.remove = function remove() {
      this.removed = !0, document.getElementById("vc-call-members").removeChild(document.getElementById("vc-user-card-" + this.playerName)), this.updatePlaceholder(), delete Gt["vc-user-card-" + this.playerName + "-volume-input"];
    };

    Wt.prototype.setVisuallyTalking = function setVisuallyTalking(t) {
    ...
    Wt.prototype.setVisuallyMuted = function setVisuallyMuted(t) {
    ...
    Wt.prototype.updateVolumeDisplay = function updateVolumeDisplay(t) {
  ...
  var Kt = function () {
    ...
    Kt.prototype.setLocation = function setLocation(t, e, n, r) {
  ...
  var Jt = function () {
    function Jt(t, e, n, r, i, o) {
      ...
      this.openAudioMc = t, this.playerName = e, this.playerUuid = e, this.streamKey = r, this.active = !0, this.ready = !1, this.location = o, this.volume = 80;var s = Cookies.get("vc-volume-of-" + e);null != s && (this.volume = parseInt(s)), this.ui = new Wt(this.openAudioMc, e, n, this.volume, function (t) {
        _this29.volume = t, Cookies.set("vc-volume-of-" + e, t, { expires: 30 }), _this29.ready && _this29.stream.setVolume(_this29.volume);
      }), this.stream = new Kt(t, i, t.voiceModule.streamKey, r, this.volume, this.ui), this.stream.setLocation(o.x, o.y, o.z, !1), this.stream.start(function () {
  ...
  var Yt = function () {
    ...
    Yt.prototype.setVisuallyActive = function setVisuallyActive(t) {
    ...
    Yt.prototype.getState = function getState() {
      return this.state;
    };

    Yt.prototype.isOn = function isOn() {
      return this.state;
    };
  ...
  var Xt = function () {
    ...
    Xt.prototype.fromString = function fromString(t) {
    ...
    Xt.prototype.setParam = function setParam(t, e) {
      return this.params.set(t, e), this;
    };

    Xt.prototype.getParam = function getParam(t) {
      return this.params.get(t);
    };

    Xt.prototype.setEventName = function setEventName(t) {
      return this.eventName = t, ie.isProd || s("Building bus message " + t), this;
    };

    Xt.prototype.getEventName = function getEventName() {
      return this.eventName;
    };

    Xt.prototype.serialize = function serialize() {
    ...
    Xt.prototype.trimmed = function trimmed() {
  ...
  var $t = function () {
    ...
    $t.prototype.onFinish = function onFinish(t) {
      return null == this.payload ? void (this.whenFinished = t) : void t(this.payload);
    };

    $t.prototype.onReject = function onReject(t) {
      return null == this.error ? void (this.whenRejected = t) : void t(this.error);
    };

    $t.prototype.handleData = function handleData(t) {
      this.payload = t, this.whenFinished(t);
    };

    $t.prototype.handleError = function handleError(t) {
  ...
  var Qt = function () {
    ...
    Qt.prototype.dropStream = function dropStream(t) {
      "open" === this.dataChannel.readyState ? this.dataChannel.send(new Xt().setEventName("DROP_STREAM").setParam("owner", t).serialize()) : s("Warning! can't drop a stream because the connection is closed");
    };

    Qt.prototype.requestStream = function requestStream(t) {
      if ("open" === this.dataChannel.readyState) {
        var e = new $t();return this.waitingPromises.set(t, e), this.dataChannel.send(new Xt().setEventName("REQUEST_STREAM").setParam("owner", t).serialize()), e;
      }{
        s("Warning! attempted to request a stream for " + t + " but the eb is closed");var _e10 = new $t();return _e10.handleError("Connection is closed"), _e10;
      }
    };

    Qt.prototype.initializeRenegotiation = function initializeRenegotiation() {
      var _this32 = this;
      ...
      this.lastNegotiationRequest = performance.now(), this.pcReceiver.createOffer().then(function (t) {
        ...
        var t = JSON.stringify({ sdp: btoa(JSON.stringify(_this32.pcReceiver.localDescription)) }),
            e = new Xt().setEventName("KICKSTART_RENEG").serialize();e += t, _this32.dataChannel.send(e);
      }).catch(function (t) {
        _this32.openAudioMc.voiceModule.handleCrash(JSON.stringify(t.toJSON()));
      });
    };

    Qt.prototype.handleRenagEnd = function handleRenagEnd() {
    ...
    Qt.prototype.registerDataChannel = function registerDataChannel(t, e) {
      var _this33 = this;
      ...
      t.addEventListener("open", function () {
        ...
        var n = t.data;var r = new Xt().fromString(n);switch (ie.isProd || s("Handling bus " + r.getEventName()), r.getEventName()) {case "REQUEST_NEG_INIT":
            ...
            var _t32 = r.trimmed(),
              ...
              _this33.handleRenagEnd(), _this33.dataChannel.send(new Xt().setEventName("CLIENT_CONFIRMED_NEG").serialize());
            ...
            _this33.lastNegotiationRequest = performance.now();var _i4 = JSON.parse(r.trimmed());_this33.pcReceiver.setRemoteDescription(new RTCSessionDescription(JSON.parse(atob(_i4.sdp)))).then(function () {
              _this33.pcReceiver.createAnswer().then(function (t) {
                var e = new Xt().setEventName("PROCESS_RESPONSE").serialize();e += btoa(JSON.stringify(t)), _this33.dataChannel.send(e), _this33.pcReceiver.setLocalDescription(t).catch(function (t) {
    ...
    Qt.prototype.contextEvent = function contextEvent(t) {
    ...
    Qt.prototype.onInternalTrack = function onInternalTrack(t, e, n) {
      var _this34 = this;
      ...
      }, 1e3))) : (s("Setting up stream for " + r), o.handleData(t), this.waitingPromises.delete(i), void this.trackQueue.delete(r));
    };
    ...
    Qt.prototype.setMute = function setMute(t) {
      var _this36 = this;
      ...
      if (this.muteCooldown) Swal.fire("Please wait a moment before doing this again");else {
        ...
        }t ? (this.openAudioMc.voiceModule.pushSocketEvent(ne.MIC_MUTE), this.dataChannel.send(new Xt().setEventName("CONTEXT_EVENT").setParam("type", "muted-stream").serialize())) : (this.openAudioMc.voiceModule.pushSocketEvent(ne.MIC_UNMTE), this.dataChannel.send(new Xt().setEventName("CONTEXT_EVENT").setParam("type", "unmuted-stream").serialize()));
      }
    };

    Qt.prototype.setVisualMuteState = function setVisualMuteState(t) {
    ...
    Qt.prototype.listenForTracks = function listenForTracks() {
      var _this37 = this;
      ...
      this.pcReceiver.addEventListener("track", function (t) {
        for (var e = 0; e < t.streams.length; e++) {
          if ("dead-mans-track" === t.streams[e].id) return;t.track.onended = function () {
            _this37.dataChannel.send(new Xt().setEventName("SCHEDULE_RENAG").serialize());
  ...
  window.randomLoadCallbacks = new Map();var Zt = n(133),
      te = n.n(Zt);
  var ee = function () {
    function ee(t, e, n) {
      var _this38 = this;
      ...
      this.openAudioMc = t, this.stream = n, this.voiceModule = e, this.id = "visual-speaking-indicator", this.harkEvents = Object(qt.a)(this.stream, {}), this.gainController = new te.a(n);var r = Cookies.get("mic-sensitivity");null != r && (r = parseInt(r), this.harkEvents.setThreshold(r)), document.getElementById("mic-sensitive-slider").value = q(this.harkEvents.getThreshold()), this.isSpeaking = !1, this.harkEvents.setInterval(5), document.getElementById("mic-sensitive-slider").oninput = function (t) {
        var e = -q(t.target.value);_this38.harkEvents.setThreshold(e), Cookies.set("mic-sensitivity", e + "", { expires: 30 });
  ...
  var ne = { MIC_MUTE: "MICROPHONE_MUTED", MIC_UNMTE: "MICROPHONE_UNMUTE", LEVEL_WHISPERING: "LEVEL_WHISPERING", LEVEL_NORMAL: "LEVEL_NORMAL", LEVEL_SHOUTING: "LEVEL_SHOUTING" };
  var re = function () {
    function re(t) {
      var _this39 = this;
      ...
      this.openAudioMc = t, this.peerManager = null, this.peerMap = new Map(), this.loadedDeviceList = !1, this.loadeMicPreference = Cookies.get("preferred-mic"), this.loudnessDetectionEnabled = !1, this.surroundSwitch = new Yt("use-surround", !0, function (t) {
    ...
    re.prototype.enable = function enable(t, e, n) {
      var _this40 = this;
    ...
    re.prototype.removePeer = function removePeer(t) {
    ...
    re.prototype.onSurrroundUpdate = function onSurrroundUpdate() {
      var _this41 = this;
    ...
    re.prototype.handleCrash = function handleCrash(t) {
    ...
    re.prototype.handleAudioPermissions = function handleAudioPermissions(t) {
      var _this42 = this;
      ...
      this.loadedDeviceList || (navigator.mediaDevices.enumerateDevices().then(function (t) {
        ...
        console.error(t), _this42.handleCrash(JSON.stringify(t.toJSON()));
          ...
          Swal.showLoading();
        } }), this.microphoneProcessing = new ee(this.openAudioMc, this, t), this.peerManager = new Qt(this.openAudioMc, this.server, this.streamKey, t, this.microphoneProcessing), this.peerManager.setup(this.onOutoingStreamStart).catch(function (t) {
    ...
    re.prototype.changeInput = function changeInput(t) {
      var _this43 = this;
    ...
    re.prototype.loadedDevices = function loadedDevices(t) {
      var _this44 = this;
    ...
    re.prototype.onOutoingStreamStart = function onOutoingStreamStart() {
      G("voice-home"), Swal.close();
    };

    re.prototype.consent = function consent(t) {
    ...
    re.prototype.permissionError = function permissionError() {
    ...
    re.prototype.pushSocketEvent = function pushSocketEvent(t) {
      null != this.peerManager && this.openAudioMc.socketModule.send(it, { event: t });
    };

    re.prototype.blurWithReason = function blurWithReason() {
    ...
    re.prototype.unblur = function unblur() {
  ...
  n.d(e, "OpenAudioEnv", function () {
    ...
    return oe;
  });var ie = { build: "307", compiler: "Mindgamesnl", platform: "Production", environment: "Linux", isProd: JSON.parse("true"), envDescription: "default-prod" };
  var oe = function (_ref2) {
    _inherits(oe, _ref2);
    ...
    function oe() {
      ...
      if ((_this45 = _possibleConstructorReturn(this, _ref2.call(this)), _this45), s("Starting build " + JSON.stringify(ie)), _this45.canStart = !1, _this45.host = null, _this45.background = null, _this45.ambianceSound = "", _this45.tokenSet = new gt().fromCache(), null == _this45.tokenSet) return _ret2 = void a(rt.BAD_AUTH), _possibleConstructorReturn(_this45, _ret2);_this45.notificationModule = new At(_this45), _this45.timeService = new tt(), _this45.messages = new et(_this45), _this45.userInterfaceModule = new nt(_this45), _this45.hueConfiguration = new Ot(_this45), _this45.mediaManager = new xt(_this45), _this45.voiceModule = new re(_this45);new Tt(pt.MAIN_BACKEND).route(_this45).then(function (t) {
        _this45.canStart = !0, _this45.host = t.host, _this45.background = t.background, _this45.ambianceSound = t.ambianceSound, a(rt.WELCOME), s("Server: " + t.serverName), o(function () {
          window.debugUi.addPanel($.ACCOUNT, "cached=" + t.fromCache + ", pc=" + t.playerCount + ", claimed=" + t.claimed + ", sfu=" + t.host + ", rtc=" + t.rtc);
        });var e = Cookies.get("volume");null != e && _this45.mediaManager.changeVolume(e), function (t, e) {
          (function () {
    ...
    oe.prototype.start = function start() {
      this.canStart && (this.canStart = !1, this.world = new Ht(this), this.hueModule = new st(this, Object(Pt.a)()), this.socketModule = new Et(this, this.host), this.messages.apply(), this.mediaManager.setupAmbianceSound(this.ambianceSound), this.mediaManager.postBoot(), new Ct(this), "" !== this.background && (document.getElementById("banner-image").src = this.background), this.mediaManager.postBoot());
    };

    oe.prototype.sendError = function sendError(t) {
  ...
  window.onload = function () {
    ie.isProd || i(), o(function () {
      ...
      }), null != t && null != t.name && (document.getElementById("in-game-name").innerText = t.name, Nt = new oe()), void document.body.addEventListener("click", z));
    });
