...
!function (e) {
  ...
  function o(e, t) {
    function i(e, t) {
      var i = 0,
          n = t || e.innerHTML,
          s = n.length;K.push(window.setInterval(function () {
    ...
    for (var e = "", t = "", i = 0; i < ce && xe != Se; ++i) {
      e += T(12288 + (0 | 16383 * I(B(fe[xe++] + 1, 0), 2))), t += T(12288 + (0 | 16383 * I(B(fe[xe++] + 1, 0), 2))), xe == Ae && (xe = 0);
    }return e + t;
  }function S() {
    for (var e = "", t = 0; t < ce && xe != Se; ++t) {
      e += T(12288 + (0 | 16383 * I(B(fe[xe++] + 1, 0), 2))), xe == Ae && (xe = 0);
    }return e;
  }function A() {
    return (xe <= Se ? 0 : Ae) + Se - xe;
  }function C(e) {
    pe = k(ye), Ee = ye, xe = 0, Se = 0, Ae = B(ye * Math.ceil(we / e), ce) << 1, ve ? (fe = E(Ae), ke = new v(we, e, 1, Ae, !0), S) : (fe = E(Ae <<= 1), ke = new v(we, e, 2, Ae, !0), x);
  }var B = Math.max,
      I = Math.min,
  ...
  var H = "https://media.openaudiomc.net/proxy?apiurl=",
      ...
      j = "https://media.openaudiomc.net/googledrive?id=";"toJSON" in Error.prototype || Object.defineProperty(Error.prototype, "toJSON", { value: function value() {
  ...
  var J = function () {
    ...
    J.prototype.show = function show(e) {
      var _this12 = this;
  ...
  var Y = function () {
    ...
    Y.prototype.send = function send(e, t) {
    ...
    Y.prototype.registerHandler = function registerHandler(e, t) {
      this.handlers[e] = t;
    };
  ...
  var K = [],
    ...
    return function () {
      for (var _e17 = K.length; _e17--;) {
        clearInterval(K[_e17]);
      }K = [];
    }(), s(this + "");
  };
  var Z = function () {
  ...
  var ee = function () {
    function ee(e) {
      ...
      function t(t, i) {
        ...
        var t = e.message;_this15.openAudioMc.notificationModule.sendNotification(e.title, t), new J("#alert-area", { closeTime: 3e4, persistent: !1, hideCloseButton: !1 }).show(e.title + "<hr />" + t);
  ...
  v.prototype.initialize = function () {
    ...
    if (0 == this.audioType) return this.samplesAlreadyWritten - this.audioHandleMoz.mozCurrentSampleOffset();if (1 == this.audioType) return (A() * ke.ratioWeight >> this.audioChannels - 1 << this.audioChannels - 1) + Ee;if (2 == this.audioType) {
      if (this.checkFlashInit() || me) return (A() * ke.ratioWeight >> this.audioChannels - 1 << this.audioChannels - 1) + Ee;if (this.mozAudioFound) return this.samplesAlreadyWritten - this.audioHandleMoz.mozCurrentSampleOffset();
    }return 0;
  ...
  var Oe = function (_Pe) {
    ...
    Oe.prototype.isAcceptable = function isAcceptable(e) {
      return e >= this.lowestAcceptable && e <= this.highestAcceptable;
    };

    Oe.prototype.handleMeasurement = function handleMeasurement(e) {
  ...
  var Le = function () {
    function Le() {
      ...
      this.buffer = new Float32Array(0), this.processor = new Oe(), this.tickTimer = new ze(function (e) {
  ...
  var Fe = function (_J2) {
    ...
    function Fe(e) {
      ...
      var _this26 = _possibleConstructorReturn(this, _J2.call(this, "#alert-area", { closeTime: 6e4, persistent: !0, hideCloseButton: !0 }));
    ...
    Fe.prototype.deniedMessage = function deniedMessage() {
      this.requestBox = new J("#alert-area", { closeTime: 5e3, persistent: !0, hideCloseButton: !0, extra: "warning" }).show("It looks like you denied OpenAudioMc's request to use your Microphone. You won't be able to join voice calls because of this. Please go to your browser settings, and enable them manually.");
    };
  ...
  var We = function () {
    function We(e, t, i, o, n, s) {
      ...
      this.main = e, this.voiceServer = t, this.roomId = i, this.accessToken = n, this.roomMembers = new Map(), this.currentUser = o, this.isUnsubscribing = !1, new J("#call-members", { closeTime: 500, persistent: !1, hideCloseButton: !0 }).show("Loading call.."), document.getElementById("call-control-box").style.display = "", document.getElementById("leave-call-button").onclick = function () {
        _this31.unsubscribe();
    ...
    We.prototype.unsubscribe = function unsubscribe() {
      ...
      this.isUnsubscribing || (this.isUnsubscribing = !0, new J("#alert-area", { closeTime: 1500, persistent: !1, hideCloseButton: !0 }).show("Quitting room, please wait."), w(this.voiceServer.rest + "/leave-room?room=" + this.roomId + "&uuid=" + this.currentUser.uuid + "&accessToken=" + this.accessToken).then(function (e) {
    ...
    We.prototype.leaveErrorhandler = function leaveErrorhandler() {
      new J("#alert-area", { closeTime: 5e3, persistent: !0, hideCloseButton: !0, extra: "warning" }).show("Something went wrong while leaving your wrong. Please try again in a moment."), this.isUnsubscribing = !1;
    };

    We.prototype.errorHandler = function errorHandler(e) {
      new J("#alert-area", { closeTime: 2e4, persistent: !1, hideCloseButton: !0, extra: "warning" }).show("A networking error occurred when loading the voice room."), console.error(e);
    };
  ...
  var je = function () {
    function je(e, t, i, o) {
      ...
      var n = [];t.forEach(function (t) {
        ...
        _this34.ignored = !0, _this34.hide(_this34), new J("#alert-area", { closeTime: 1500, persistent: !1, hideCloseButton: !0 }).show("Starting call."), setTimeout(function () {
          i();
        }, 1e3);
        ...
        _this34.ignored || (_this34.ignored = !0, _this34.hide(_this34), new J("#alert-area", { closeTime: 1500, persistent: !1, hideCloseButton: !0 }).show("Ignored call."), o());
  ...
  var qe = function () {
    ...
    qe.prototype.promptCall = function promptCall(e, t, i, o, n) {
      ...
      }) : new J("#alert-area", { closeTime: 2e4, persistent: !1, hideCloseButton: !1, extra: "warning" }).show("You just got invited to another call, but you are already chitter-chatting. There for your new call request was ignored. You can always leave this call and request another invite.");
    };

    qe.prototype.leaveErrorhandler = function leaveErrorhandler() {
      new J("#alert-area", { closeTime: 5e3, persistent: !0, hideCloseButton: !0, extra: "warning" }).show("Failed to cancel call. Please try again in a moment.");
    };
  ...
  var Ge = function () {
    ...
    Ge.prototype.requestNotificationPermissions = function requestNotificationPermissions() {
      ...
      Notification.requestPermission().then(function (e) {
        "granted" === e && (_this37.requestBox.hide(), new J("#alert-area", { closeTime: 1500, persistent: !1, hideCloseButton: !0 }).show("Hurray! you'll now receive notifications"), _this37.sendNotification("Testing testing 123", "It worked! you have configured Notifications correctly!"));
      });
    };
    ...
    ot.prototype.renderAudio2D = function renderAudio2D() {
      ...
      try {
        for (var _iterator21 = e[Symbol.iterator](), _step21; !(_iteratorNormalCompletion21 = (_step21 = _iterator21.next()).done); _iteratorNormalCompletion21 = true) {
          ...
          var _e25 = t.get(_i7.source);null != _e25 ? Array.isArray(_e25) ? (_e25.push(_i7), t.set(_i7.source, _e25)) : _e25.distance > _i7.distance && _i7.distance <= _i7.speaker.maxDistance && t.set(_i7.source, _i7) : _i7.speaker.type == et ? _i7.distance <= _i7.speaker.maxDistance && t.set(_i7.source, _i7) : _i7.distance <= _i7.speaker.maxDistance && t.set(_i7.source, [_i7]);
        }
      } catch (err) {
  ...
  var nt = function (_ref2) {
    ...
    function nt() {
      ...
      if ((_this40 = _possibleConstructorReturn(this, _ref2.call(this)), _this40), _this40.canStart = !1, _this40.host = null, _this40.background = null, _this40.tokenSet = new D().fromUrl(window.location.href), null == _this40.tokenSet) return _ret2 = void (document.getElementById("welcome-text-landing").innerHTML = "The audio client is only available for players who are online in the server. Use <small>/audio</small> to obtain a URL<br />"), _possibleConstructorReturn(_this40, _ret2);_this40.notificationModule = new Ge(_this40), _this40.timeService = new z(), _this40.messages = new L(_this40), _this40.userInterfaceModule = new R(_this40), _this40.hueConfiguration = new te(_this40), _this40.mediaManager = new G(_this40), _e = new (window.AudioContext || window.webkitAudioContext)(), _this40.voiceModule = new qe(_this40), _this40.boot();new le("https://plus.openaudiomc.net/").route(_this40).then(function (e) {
        _this40.canStart = !0, _this40.host = e.host, _this40.background = e.background;
      }).catch(function (e) {
        console.error("Exception thrown", e.stack), _this40.userInterfaceModule.kickScreen("Your current URL appears to be invalid. Please request a new one in-game using the /audio command. If this issue if persists please contact a member of staff."), new J("#alert-area", { closeTime: 2e4, persistent: !1, hideCloseButton: !0, extra: "warning" }).show("A networking error occurred while connecting to the server, please request a new url and try again.");
      });return _possibleConstructorReturn(_this40);
    }

    nt.prototype.start = function start() {
      this.canStart && (this.canStart = !1, this.world = new ot(this), this.hueModule = new N(this, Object(Je.a)()), this.socketModule = new Y(this, this.host), this.messages.apply(), new ee(this), "" !== this.background && (document.getElementById("page").style = "vertical-align: middle;\n    background:\n            url(" + this.background + ");\n    -webkit-background-size: cover;\n    background-size: cover;"), this.mediaManager.postBoot());
    };
  ...
  !function () {
    if (navigator.vendor && -1 < navigator.vendor.indexOf("Apple") && navigator.userAgent && -1 == navigator.userAgent.indexOf("CriOS") && -1 == navigator.userAgent.indexOf("FxiOS")) return void (window.location.href = "https://mindgamesnl.github.io/OpenAudioMc/browsers.html");var e = new D().fromUrl(window.location.href);null == e ? (document.getElementById("footer-welcome").innerText = "No authentication provided", document.getElementById("boot-button").style.display = "none", document.getElementById("welcome-text-landing").innerHTML = "The audio client is only available for players who are online in the server. Use <small>/audio</small> to obtain a URL<br />") : (document.body.onclick = function () {
      Ye.canStart && Ye.start();
    }, null != e && null != e.name && (document.getElementById("sidebar-head").style.background = "linear-gradient(0deg, rgba(42, 38, 95, .8), rgba(42, 38, 95, .4)), url(https://minotar.net/avatar/" + e.name + ")", document.getElementById("footer-welcome").innerText = "Logged in as " + e.name, Ye = new nt()), w("https://client.openaudiomc.net/status").then(function (e) {
      e.json().then(function (e) {
