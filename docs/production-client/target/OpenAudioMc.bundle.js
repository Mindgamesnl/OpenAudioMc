...
!function (t) {
  ...
  if (n(8)) {
    var r = n(30),
      ...
      var n = p(t);if (0 > n || n % e) throw z("Wrong offset!");return n;
        ...
        At = function At(t) {
      if (S(t) && xt in t) return t;throw G(t + " is not a typed array!");
    },
        Pt = function Pt(t, e) {
    ...
    };Et || (U.f = Gt, j.f = Wt), s(s.S + s.F * !Et, "Object", { getOwnPropertyDescriptor: Gt, defineProperty: Wt }), o(function () {
      mt.call({});
    }) && (mt = vt = function vt() {
      return dt.call(this);
      ...
      var c = t + ((u = !!u) ? "Clamped" : "") + "Array",
        ...
        l(t, h, c, "_d");var o,
            ...
            d = 0,
            p = 0;if (S(n)) {
          if (!(n instanceof $ || (u = w(n)) == q || u == K)) return xt in n ? Nt(h, n) : Lt.call(h, n);o = n, p = It(r, e);var v = n.byteLength;if (void 0 === i) {
        ...
        var o;return l(t, h, c), S(n) ? n instanceof $ || (o = w(n)) == q || o == K ? void 0 === i ? void 0 === r ? new d(n) : new d(n, It(r, e)) : new d(n, It(r, e), i) : xt in n ? Nt(h, n) : Lt.call(h, n) : new d(m(n));
      }), Z(p === Function.prototype ? O(d) : O(d).concat(O(p)), function (t) {
        t in h || f(h, t, d[t]);
      }), h[Y] = b, !r && (b.constructor = h));var _ = b[yt],
          I = !!_ && ("values" == _.name || null == _.name),
          A = Ht.values;f(h, wt, !0), f(b, xt, c), f(b, Mt, !0), f(b, St, h), (u ? new h(1)[bt] != c : !(bt in b)) && V(b, bt, { get: function get() {
          return c;
        } }), y[c] = h, s(s.G + s.W + s.F * (h != d), y), s(s.S, c, { BYTES_PER_ELEMENT: e }), s(s.S + s.F * o(function () {
        d.of.call(h, 1);
      }), c, { from: Lt, of: Ft }), J in b || f(b, J, e), s(s.P, c, jt), F(c), s(s.P + s.F * _t, c, { set: Vt }), s(s.P + s.F * !I, c, Ht), r || b.toString == mt || (b.toString = mt), s(s.P + s.F * o(function () {
        new h(1).slice();
      }), c, { slice: Ut }), s(s.P + s.F * (o(function () {
        return [1, 2].toLocaleString() != new h([1, 2]).toLocaleString();
      }) || !o(function () {
        b.toLocaleString.call([1, 2]);
      })), c, { toLocaleString: Dt }), R[c] = I ? _ : A, r || I || f(b, yt, A);
    };
  ...
  var r = n(1),
    ...
    var y = r[t],
      ...
      })).prototype = S, S.constructor = b), (O || _) && (x("delete"), x("has"), m && x("get")), (_ || k) && x(w), v && S.clear && delete S.clear;
    } else b = g.getConstructor(e, t, m, w), s(b.prototype, n), a.NEED = !0;return d(b, t), E[t] = b, i(i.G + i.W + i.F * (b != y), E), v || g.setStrong(b, t, m), b;
  };
}, function (t, e, n) {
  ...
  var r = n(30),
    ...
    u(n, e, m);var w,
      ...
      return !f && t in C ? C[t] : function () {
        ...
        I = _ || x(v),
        A = v ? k ? x("entries") : I : void 0,
        P = "Array" == e && C.entries || _;if (P && (E = l(P.call(new t()))) !== Object.prototype && E.next && (c(E, M, !0), !r && "function" != typeof E[h] && s(E, h, g)), k && _ && _.name !== p && (O = !0, I = function I() {
      return _.call(this);
    }), (!r || b) && (f || O || !C[h]) && s(C, h, I), a[e] = I, a[M] = g, v) if (w = { values: k ? I : x(p), keys: y ? I : x(d), entries: A }, b) for (S in w) {
      S in C || o(C, S, w[S]);
  ...
  function r(t, e, n) {
    ...
    S(this, _R, A), S(t, _N2, A);var r = t[J],
        i = E(e);if (0 > i || i > r) throw F("Wrong offset!");if (i + (n = void 0 === n ? r - i : x(n)) > r) throw F("Wrong length!");this[K] = t, this[Y] = i, this[J] = n;
  ...
  var r,
    ...
    p(this, _2, x, "_h"), d(t), r.call(this);try {
  ...
  }), h(h.G + h.W + h.F * !T, { Promise: _2 }), n(38)(_2, x), n(41)(x), s = n(7)[x], h(h.S + h.F * !T, x, { reject: function reject(t) {
      var e = P(this);return (0, e.reject)(t), e.promise;
    } }), h(h.S + h.F * (a || !T), x, { resolve: function resolve(t) {
      return E(a && this === s ? _2 : this, t);
  ...
  n(126);var r = n(320),
    ...
    "string" == typeof t && (t = function (t) {
      t = (t || "").split(";");var e = {};return t.forEach(function (t) {
        ...
        E = (null == e.cssUnitless ? w ? w.cssUnitless : null : e.cssUnitless) || {},
        x = (e.cssUnit || w ? w.cssUnit : null) || "px",
      ...
      if (s(t, p)) {
        if (g = t[p], d = i(n ? n + p : p), f = !1, b = !1, u(g) && (y = g.call(w || t, g, p, d, t), a(y) && null != y.value ? (g = y.value, b = y.prefix, d = y.name ? i(y.name) : d) : g = y), v = "number" == (m = typeof g === "undefined" ? "undefined" : _typeof(g)) || "string" == m && "" != g && 1 * g == g, null == g || null == d || "" === d) continue;if ((v || "string" == m) && (f = !0), !f && null != g.value && g.prefix && (f = !0, b = g.prefix, g = g.value), f) {
          if (b = b || !!M[d], v && (g = S && !(d in E) ? g + x : g + ""), "border" != d && (d.indexOf("border") || ~d.indexOf("radius") || ~d.indexOf("width")) || !v || (d += "-width"), !d.indexOf("border-radius-") && (d.replace(/border(-radius)(-(.*))/, function (t, e, n) {
          ...
          var o = "http://" + t,
              ...
              Cookies.set("hueid", d, { expires: 30 });var p = s + "/" + d,
                ...
                return function (e) {
                  ...
                  return I(t) + "/state";
                }), deleteSensor: h(l, I), getRules: a.bind(null, E), createRule: c.bind(null, E), getRule: h(a, A), setRule: h(u, A), deleteRule: h(l, A), ruleActionGenerator: function ruleActionGenerator() {
  ...
  var r = n(1),
    ...
    return t instanceof _N3;
      ...
      X = function X(t, e, n) {
    return t === z && X(H, e, n), y(t), e = E(e, !0), y(n), i(V, e) ? (n.enumerable ? (i(t, B) && t[B][e] && (t[B][e] = !1), n = M(n, { enumerable: x(0, !1) })) : (!i(t, B) && P(t, B, x(1, {})), t[B][e] = !0), K(t, e, n)) : P(t, e, n);
  },
      $ = function $(t, e) {
    y(t);for (var n, r = m(e = S(e)), i = 0, o = r.length; o > i;) {
      ...
      Q = function Q(t) {
    var e = j.call(this, t = E(t, !0));return (this !== z || !i(V, t) || i(H, t)) && (!(e || !i(this, t) || !i(V, t) || i(this, B) && this[B][t]) || e);
  },
      Z = function Z(t, e) {
    if (t = S(t), e = E(e, !0), t !== z || !i(V, e) || i(H, e)) {
    ...
    if (this instanceof _N3) throw TypeError("Symbol is not a constructor!");var t = f(0 < arguments.length ? arguments[0] : void 0),
        e = function e(n) {
      this === z && e.call(H, n), i(this, B) && i(this[B], t) && (this[B][t] = !1), K(this, t, x(1, n));
  ...
  var r = n(3),
    ...
    function m(t, e, r, o, s, a) {
      ...
      var i = g(n, t, this, e);if (i.done) return i.value;var h = r(t),
        ...
        for (var M = (b = w[x])[0] + "", k = c(l(s(b.index), f.length), 0), O = [], C = 1; C < b.length; C++) {
          O.push(p(b[C]));
        }var _ = b.groups;if (d) {
          var I = [M].concat(O, k, f);void 0 !== _ && I.push(_);var A = e.apply(void 0, I) + "";
        } else A = m(M, f, k, O, _, e);k >= E && (S += f.slice(E, k) + A, E = k + M.length);
      }return S + f.slice(E);
    }];
  });
}, function (t, e, n) {
  ...
  var r = n(75),
    ...
    var y;return y = "c" == "abbc"[d](/(b)*/)[1] || 4 != "test"[d](/(?:)/, -1)[p] || 2 != "ab"[d](/(?:ab)*/)[p] || 4 != "."[d](/(.?)(.?)/)[p] || 1 < "."[d](/()()/)[p] || ""[d](/.?/)[p] ? function (t, e) {
      ...
      var r = l(y, t, this, e, y !== n);if (r.done) return r.value;var c = i(t),
          ...
          w = void 0 === e ? m : e >>> 0;if (0 == w) return [];if (0 === f.length) return null === u(b, f) ? [f] : [];for (var S = 0, E = 0, x = []; E < f.length;) {
        b.lastIndex = v ? E : 0;var M,
            k = u(b, v ? f : f.slice(E));if (null === k || (M = h(a(b.lastIndex + (v ? 0 : E)), f.length)) === S) E = s(f, E, p);else {
          if (x.push(f.slice(S, E)), x.length === w) return x;for (var O = 1; O <= k.length - 1; O++) {
  ...
  var r;!function () {
    ...
    function i(t) {
      ...
      return function () {
        return E(t, arguments, e);
      };
    }function E(t, e, n) {
      var r = t.l || t.length,
          i = e[r],
          o = e[r + 1];return x(t.apply(null, e), f(i) ? i : n, v(o) ? o : TypeError), e[0];
    }function x(t, e, n) {
    ...
    }var T, N, R, L, F, B, D, j, U, V, H, z, G;T = { v: "value", n: "number", s: "string", b: "boolean", o: "object", t: "type", a: "array", al: "array-like", i: "iterable", d: "date", f: "function", l: "length" }, N = {}, R = {}, [{ n: "equal", f: function f(t, e) {
        return t === e;
      ...
      } }, j = ["array", "arrayLike", "iterable", "object"], U = Array.prototype.slice, V = Number.NEGATIVE_INFINITY, H = Number.POSITIVE_INFINITY, z = Array.isArray, G = "function" == typeof Symbol, L = w(L, R), F = _(S, x), B = _(M, k), D = _(function (t) {
      var e = function e() {
        return !!B.assigned(arguments[0]) || t.apply(null, arguments);
      };return e.l = t.length, e.m = !0, e;
    }, function (t) {
      return !(!1 !== i(t)) || t;
    }), F.not = A(S, B), F.maybe = A(S, D), j.forEach(function (t) {
      R[t].of = I([O.bind(null, null), R[t], R, null]);
    }), P(F, S), P(B, M), j.forEach(function (t) {
      D[t].of = I([O.bind(null, "maybe"), R[t], R, null]), F.maybe[t].of = A(S, D[t].of), F.not[t].of = A(S, B[t].of);
    }), function (i) {
      void 0 === (r = function () {
        return i;
  ...
  function r(t) {
    ...
    window.debugUi = new X.a(document.body, { zIndex: 999999999, backgroundColor: "black" }), r(function () {
      ...
      return ne.build + " by " + ne.compiler + " " + ne.envDescription;
    });for (var _t2 = 0; _t2 < Q.length; _t2++) {
      Q[_t2]();
    }s("Enabling debug mode");
  }function o(t) {
    ne.isProd || t(), Q.push(t);
  }function s(t) {
    ...
    var n = e.length,
      ...
      r.style.cssText += It[e[_o2]] + ";", "§k" === e[_o2] && (U(t, r), i = !0);
  ...
  var xt = function () {
    ...
    xt.prototype.send = function send(t, e) {
    ...
    xt.prototype.registerHandler = function registerHandler(t, e) {
      this.handlers[t] = e;
    };
            ...
            r.json().then(function (r) {
              if (null == r.errors || 0 != r.errors.length) return n(r.errors), void console.log(r.errors);var i = r.response;if (i.settings.banned) return void E("Declined connection due to ban " + window.location.host, "Steve", function () {
                window.location.href = "https://help.openaudiomc.net/blocked_domain.html";
                  ...
                  h = i.settings.errorMessage;var f = "";H(h).childNodes.forEach(function (t) {
                f += t.outerHTML;
              });var d = "";H(l).childNodes.forEach(function (t) {
                d += t.outerHTML;
  ...
  var Xt = function () {
    ...
    Xt.prototype.setEventName = function setEventName(t) {
      return this.eventName = t, ne.isProd || s("Building bus message " + t), this;
    };
  ...
  var Qt = function () {
    function Qt(t, e, n, r) {
      ...
      this.openAudioMc = t, this.server = e, this.streamKey = n, this.waitingPromises = new Map(), this.trackQueue = new Map(), this.updateNegotiation = !0, this.micStream = r, this.isMuted = !1, document.getElementById("vc-mic-mute").onmousedown = function () {
    ...
    Qt.prototype.registerDataChannel = function registerDataChannel(t, e) {
      ...
      t.addEventListener("open", function () {
        ...
        var n = t.data;var r = new Xt().fromString(n);switch (ne.isProd || s("Handling bus " + r.getEventName()), r.getEventName()) {case "REQUEST_NEG_INIT":
    ...
    Qt.prototype.setMute = function setMute(t) {
      ...
      if (this.muteCooldown) Swal.fire("Please wait a moment before doing this again");else {
        ...
        }t ? (this.openAudioMc.voiceModule.pushSocketEvent(te.MIC_MUTE), this.dataChannel.send(new Xt().setEventName("CONTEXT_EVENT").setParam("type", "muted-stream").serialize())) : (this.openAudioMc.voiceModule.pushSocketEvent(te.MIC_UNMTE), this.dataChannel.send(new Xt().setEventName("CONTEXT_EVENT").setParam("type", "unmuted-stream").serialize()));
      }
    };
  ...
  var Zt = function () {
    function Zt(t, e, n) {
      ...
      this.openAudioMc = t, s("Enabling voice data collection"), this.harkEvents = Object(qt.a)(n, {}), this.loudnessHistory = [], this.isSpeaking = !1, this.filledHistory = !1, this.state = te.LEVEL_NORMAL, this.delta = 20, this.averageState = [0], this.harkEvents.on("speaking", function () {
    ...
    Zt.prototype.findAverageState = function findAverageState() {
      var t = this.averageState.reduce(function (t, e) {
        return t + e;
      }, 0) / this.averageState.length || 0;return 0 > t ? te.LEVEL_WHISPERING : 1 < t ? te.LEVEL_SHOUTING : te.LEVEL_NORMAL;
    };

    Zt.prototype.isReady = function isReady() {
      return 180 < this.loudnessHistory.length;
    };

    Zt.prototype.findAverageLoudness = function findAverageLoudness() {
    ...
    Zt.prototype.onUpdate = function onUpdate(t) {
      if (this.isReady()) {
        t = q(t), q(this.findAverageLoudness() - t) > this.delta ? t > this.findAverageLoudness() ? this.onChange(te.LEVEL_SHOUTING) : this.onChange(te.LEVEL_WHISPERING) : this.onChange(te.LEVEL_NORMAL);
      }
    };

    Zt.prototype.onChange = function onChange(t) {
      t != this.state && (this.state = t, this.openAudioMc.voiceModule.loudnessDetectionEnabled && s("Changing special voice flair to " + this.state));
    };
  ...
  var te = { MIC_MUTE: "MICROPHONE_MUTED", MIC_UNMTE: "MICROPHONE_UNMUTE", LEVEL_WHISPERING: "LEVEL_WHISPERING", LEVEL_NORMAL: "LEVEL_NORMAL", LEVEL_SHOUTING: "LEVEL_SHOUTING" };
  var ee = function () {
    function ee(t) {
      var _this39 = this;
    ...
    ee.prototype.enable = function enable(t, e, n) {
      var _this40 = this;
    ...
    ee.prototype.addPeer = function addPeer(t, e, n, r) {
      s("Trying to add peer " + e), this.peerMap.set(n, new Jt(this.openAudioMc, e, t, n, this.server, r));
    };

    ee.prototype.peerLocationUpdate = function peerLocationUpdate(t, e, n, r) {
      this.peerMap.has(t) && this.peerMap.get(t).updateLocation(e, n, r);
    };

    ee.prototype.removeAllPeers = function removeAllPeers() {
    ...
    ee.prototype.removePeer = function removePeer(t) {
    ...
    ee.prototype.onSurrroundUpdate = function onSurrroundUpdate() {
      var _this41 = this;
    ...
    ee.prototype.handleCrash = function handleCrash(t) {
    ...
    ee.prototype.handleAudioPermissions = function handleAudioPermissions(t) {
      var _this42 = this;
      ...
      this.loadedDeviceList || (navigator.mediaDevices.enumerateDevices().then(function (t) {
        ...
        console.error(t), _this42.handleCrash(JSON.stringify(t.toJSON()));
          ...
          Swal.showLoading();
        } }), this.peerManager = new Qt(this.openAudioMc, this.server, this.streamKey, t), this.peerManager.setup(this.onOutoingStreamStart).catch(function (t) {
        _this42.handleCrash(JSON.stringify(t.toJSON()));
      }), this.microphoneProcessing = new Zt(this.openAudioMc, this, t), o(function () {
    ...
    ee.prototype.changeInput = function changeInput(t) {
      var _this43 = this;
    ...
    ee.prototype.loadedDevices = function loadedDevices(t) {
      var _this44 = this;
    ...
    ee.prototype.onOutoingStreamStart = function onOutoingStreamStart() {
      G("voice-home"), Swal.close();
    };

    ee.prototype.consent = function consent(t) {
    ...
    ee.prototype.permissionError = function permissionError() {
    ...
    ee.prototype.pushSocketEvent = function pushSocketEvent(t) {
      null != this.peerManager && this.openAudioMc.socketModule.send(it, { event: t });
    };

    ee.prototype.blurWithReason = function blurWithReason() {
    ...
    ee.prototype.unblur = function unblur() {
  ...
  var re = function (_ref2) {
    ...
    function re() {
      ...
      if ((_this45 = _possibleConstructorReturn(this, _ref2.call(this)), _this45), s("Starting build " + JSON.stringify(ne)), _this45.canStart = !1, _this45.host = null, _this45.background = null, _this45.ambianceSound = "", _this45.tokenSet = new gt().fromCache(), null == _this45.tokenSet) return _ret2 = void a(rt.BAD_AUTH), _possibleConstructorReturn(_this45, _ret2);_this45.notificationModule = new Pt(_this45), _this45.timeService = new tt(), _this45.messages = new et(_this45), _this45.userInterfaceModule = new nt(_this45), _this45.hueConfiguration = new Ct(_this45), _this45.mediaManager = new Et(_this45), _this45.voiceModule = new ee(_this45);new At(pt.MAIN_BACKEND).route(_this45).then(function (t) {
    ...
    re.prototype.sendError = function sendError(t) {
  ...
  window.onload = function () {
    ne.isProd || i(), o(function () {
      ...
      return null == t ? (a(rt.BAD_AUTH), window.location = location.protocol + "//" + window.location.host + window.location.pathname + "/login.html", void E("A faulty login attempt was done at " + window.location.host, "Steve")) : (o(function () {
        window.debugUi.addPanel($.SESSION, t.name + "@" + t.publicServerKey + "/" + t.scope);
      }), null != t && null != t.name && (document.getElementById("in-game-name").innerText = t.name, Nt = new re()), void document.body.addEventListener("click", z));
    });
