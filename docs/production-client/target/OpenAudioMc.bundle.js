...
!function (t) {
  ...
  function r(t, e, n) {
    ...
    M(Et.ERROR_REPORTING, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ playerName: e, message: "build 567: " + t }) }).then(function (t) {
  ...
  var ge = function () {
    function ge() {
      var _languageMappings;

      _classCallCheck(this, ge);

      this.messages = {}, this.seeded = !1, this.seededValues = [], this.currentLangFile = "", this.forcedValues = {}, this.languageMappings = (_languageMappings = { gb: "en.lang", us: "en.lang", nl: "nl.lang", be: "nl.lang", fr: "fr.lang", ru: "ru.lang", ua: "ru.lang" }, _defineProperty(_languageMappings, "be", "ru.lang"), _defineProperty(_languageMappings, "kz", "ru.lang"), _defineProperty(_languageMappings, "md", "ru.lang"), _defineProperty(_languageMappings, "hk", "chi.lang"), _defineProperty(_languageMappings, "cn", "chi.lang"), _languageMappings), window.getMessageString = this.getString, window.debugHooks.loadLanguage = this.load;
    }
    ...
    ge.prototype.load = function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(t) {
        var e, _n17, _t39, _e14, _r12, _i10, _o8, _e15, _n18, _t40, _e16;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 3;
                return fetch(window.location.pathname + window.location.search + t);
              ...
              case 8:
                ...
                if (!(_t39 = _n17[_e14], _t39.startsWith("#") || 5 > _t39.length)) {
                  _context5.next = 11;
                  break;
                }
              ...
              case 11:
                ...
                for (_n18 = 0; _n18 < _t39.length; _n18++) {
                  _e15 = _t39[_n18], _r12 ? _o8 += _e15 : "=" === _e15 ? _r12 = !0 : _i10 += _e15;
              ...
              case 17:
                if (this.currentLangFile = t, window.openAudioMc.messageModule.seeded) {
                  for (_e16 = 0; _e16 < window.openAudioMc.messageModule.seededValues.length; _e16++) {
                    _t40 = window.openAudioMc.messageModule.seededValues[_e16], window.openAudioMc.messageModule.renderKeyToDom(_t40.key, _t40.value, _t40.placeholders);
  ...
  n.d(e, "OpenAudioEnv", function () {
    ...
    return ve;
  });var me = { build: "567", compiler: "Mats", platform: "Production", environment: "Linux", isProd: JSON.parse("true"), envDescription: "default-prod" };window.debugHooks = {}, u(function () {
  ...
  var ve = function (_ref6) {
    ...
    function ve() {
      ...
      if ((_this49 = _possibleConstructorReturn(this, _ref6.call(this)), _this49), c("Starting build " + JSON.stringify(me)), _this49.messageModule = new ge(), _this49.canStart = !1, _this49.host = null, _this49.background = null, _this49.ambianceSound = "", _this49.isPatreon = !1, _this49.tokenSet = new Mt().fromCache(), null == _this49.tokenSet) return _ret2 = void l(dt.BAD_AUTH), _possibleConstructorReturn(_this49, _ret2);_this49.notificationModule = new Vt(_this49), _this49.timeService = new lt(), _this49.userInterfaceModule = new ht(_this49), _this49.hueConfiguration = new Lt(_this49), _this49.mediaManager = new Pt(_this49), _this49.voiceModule = new pe(_this49), J("preparing session, welcome " + _this49.tokenSet.name);new Ut(Et.MAIN_BACKEND).route(_this49).then(function () {
            ...
            while (1) {
              switch (_context6.prev = _context6.next) {
                ...
                case 3:
                  ...
                  _context6.t0 = t.useTranslations;
    ...
    _inherits(_class2, _ref8);

    function _class2() {
      _classCallCheck(this, _class2);

      return _possibleConstructorReturn(this, _ref8.apply(this, arguments));
    }
