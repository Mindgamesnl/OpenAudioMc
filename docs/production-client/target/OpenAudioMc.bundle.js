...
!function (t) {
  ...
  function r(t, e, n) {
    ...
    E(Mt.ERROR_REPORTING, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ playerName: e, message: "build 434: " + t }) }).then(function (t) {
  ...
  n.d(e, "OpenAudioEnv", function () {
    ...
    return ve;
  });var me = { build: "434", compiler: "Mindgamesnl", platform: "Production", environment: "Linux", isProd: JSON.parse("true"), envDescription: "default-prod" };window.debugHooks = {}, a(function () {
