        ...
        try {
            ...
            ((Emitter) socket)
                    ...
                    .on("userdisconnect", args -> {
                        Bukkit.getServer().getPluginManager().callEvent(new SocketUserDisconnectEvent((String) args[0]));
                    })
                    ...
                    .on("command", args -> {
                        Bukkit.getServer().getPluginManager().callEvent(new SocketCommandEvent(args));
                    })
