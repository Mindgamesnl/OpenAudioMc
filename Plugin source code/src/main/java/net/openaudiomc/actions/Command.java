...
@UtilityClass public class Command {
   ...
   * @param src the src
   */
  @SuppressWarnings("unchecked") public static void playRegion(String name, String src) {
    JSONObject obj = new JSONObject();
    obj.put("type", "region");
   ...
   * @param name the name
   */
  @SuppressWarnings("unchecked") public static void stopRegion(String name, String src) {
    JSONObject obj = new JSONObject();
    obj.put("type", "region");
   ...
   * @param name the name
   */
  @SuppressWarnings("unchecked") public static void stopAllRegions(String name) {
    JSONObject obj = new JSONObject();
    obj.put("type", "region");
   ...
   * @param src the src
   */
  @SuppressWarnings("unchecked") public static void createBuffer(String name, String src) {
    JSONObject obj = new JSONObject();
    obj.put("type", "buffer");
   ...
   * @param name the name
   */
  @SuppressWarnings("unchecked") public static void playBuffer(String name) {
    JSONObject obj = new JSONObject();
    obj.put("type", "buffer");
   ...
   */
  @SuppressWarnings("unchecked") public static void sendMessage(String name, String message) {
    JSONObject obj = new JSONObject();
    obj.put("type", "ui");
  ...
  @SuppressWarnings("unchecked") public static void enableHue(String name) {
    JSONObject obj = new JSONObject();
    obj.put("command", "hue");
    obj.put("type", "init");
    String command = obj.toString();
   ...
   */
  @SuppressWarnings("unchecked") public static void hueSet(String name, String color) {
    JSONObject obj = new JSONObject();
    obj.put("command", "hue");
    obj.put("type", "set");
   ...
   * @param name the name
   */
  @SuppressWarnings("unchecked") public static void hueReset(String name) {
    JSONObject obj = new JSONObject();
    obj.put("command", "hue");
    obj.put("type", "reset");
    String command = obj.toString();
   ...
   * @param name the name
   */
  @SuppressWarnings("unchecked") public static void hueBlink(String name) {
    JSONObject obj = new JSONObject();
    obj.put("command", "hue");
    obj.put("type", "blink");
    String command = obj.toString();
   ...
   * @param name the name
   */
  @SuppressWarnings("unchecked") public static void hueCycle(String name) {
    JSONObject obj = new JSONObject();
    obj.put("command", "hue");
   ...
   * @param name the name
   */
  @SuppressWarnings("unchecked") public static void hueStopEffect(String name) {
    JSONObject obj = new JSONObject();
    obj.put("command", "hue");
    obj.put("type", "stop");
    String command = obj.toString();
   ...
   */
  @SuppressWarnings("unchecked") public static void setBg(String name, String target) {
    JSONObject obj = new JSONObject();
   ...
   * @param name the name
   */
  @SuppressWarnings("unchecked") public static void resetBg(String name) {
    JSONObject obj = new JSONObject();
    obj.put("command", "setbg");
    obj.put("type", "reset");
    String command = obj.toString();
  ...
  @SuppressWarnings("unchecked") public static void playLoop(String name, String src) {
    JSONObject obj = new JSONObject();
  ...
  @SuppressWarnings("unchecked") public static void sendJSON(String name, String src) {
    JSONObject obj = new JSONObject();
  ...
  @SuppressWarnings("unchecked") public static void StopID(String name, String id) {
    JSONObject obj = new JSONObject();
  ...
  @SuppressWarnings("unchecked") public static void ToggleID(String name, String id) {
    JSONObject obj = new JSONObject();
  ...
  @SuppressWarnings("unchecked") public static void playList(String name, JSONArray jsonArray) {
  ...
  @SuppressWarnings("unchecked") public static void addJs(String name, String src) {
    JSONObject obj = new JSONObject();
  ...
  @SuppressWarnings("unchecked") public static void addCss(String name, String src) {
    JSONObject obj = new JSONObject();
    obj.put("command", "loadmod");
    obj.put("type", "css");
    obj.put("src", src);
